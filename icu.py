    ...
    def update_frame(self):
        ...
        if ret1:
            ...
            if len(faces)>0:
                ...
                if name == 'Unknown':
                    self.face_label1.setStyleSheet('color: {}'.format('red'))
                    self.face_label1.setText('!!!!!!!!!!!!Alert!!!!!!!!: Unknown Person detected')                    
                else:
                    self.face_label1.setStyleSheet('color: {}'.format('green'))
                ...
                self.face_label1.setStyleSheet('color: {}'.format('blue'))
